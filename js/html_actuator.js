...
HTMLActuator.prototype.message = function (won) {
  ...
  mytxt[1]="洪丝丝不给你巧克力不帮你牵红线！";
  mytxt[2]="程若晖在帮别人叠心心哦！";
  mytxt[3]="邵芳芳的美腿儿离你越来越远！";
  mytxt[4]="张美真爱钱钱不爱你！";
  mytxt[5]="烂赌婆独自去赌坊不带你玩！";
  mytxt[6]="你忍心看着江玉麟女儿身被发现而不去救她？";
  mytxt[7]="程天蓝说：漂亮就行，不漂亮的都重新开始~";
  mytxt[8]="老婆大人判你重新开始";
  mytxt[9]="快来救华清瑜呀~又被危永标欺负了";
  mytxt[10]="永远只有一个燕红叶~";
  mytxt[11]="告诉忆莲远离爷爷";
  mytxt[12]="帮俏君淹shi芊芊吧，徐飞永远只爱俏君";
  mytxt[13]="看不见宣萱的太阳花了 = =";
  
  var text3 = function (m) { var r = 0; while (m > 1) r++, m >>= 1; return r; }
  var type    = won ? "game-won" : "game-over";
  var message = won ? "宣萱对你说：你是最棒的！" : mytxt[text3(maxscore)-3];
